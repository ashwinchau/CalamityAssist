...
public class Forgot_password_hospital extends Activity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot_email=(EditText)findViewById(R.id.hospital_forgot_email);
    ...
    private void sendEmail() {
        ...
        String message = "Hello this is Calamity Assist Hospital.. Your One Time Password is " + otp + "....";
    ...
    class forgot_Login extends AsyncTask<String, String, String> {
        ...
        final String hos_email=forgot_email.getText().toString().trim();

        ProgressDialog pg;

        @Override
        protected void onPreExecute() {
            pg = new ProgressDialog(Forgot_password_hospital.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,config.forgot,new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (j.getString("Status").equalsIgnoreCase("True")) {
                            if (j.getString("Message").equalsIgnoreCase("Successfully sent Otp...")) {
                                ...
                                startActivity(new Intent(Forgot_password_hospital.this, otp_verify.class));
                                ...
                                for(int i=0;i<jsonArray.length();i++) {
                                    ...
                                    Intent intent = new Intent(Forgot_password_hospital.this, otp_verify.class);

                                    intent.putExtra("otp",otp);
                                    intent.putExtra("hospital_id", hospital_id);
                                    intent.putExtra("hospital_email", hos_email);
                            ...
                            Toast.makeText(Forgot_password_hospital.this, "Invalid Email ID", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    new Response.ErrorListener()
                    {
                        ...
                        {
                            Toast.makeText(Forgot_password_hospital.this, error.toString(), Toast.LENGTH_LONG).show();
                        }
                    })
            {
                @Override
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(Forgot_password_hospital.this);
