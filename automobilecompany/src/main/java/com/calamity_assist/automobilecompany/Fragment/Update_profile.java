...
import com.calamity_assist.automobilecompany.config;
 ...
 */
public class Update_profile extends Fragment implements Validator.ValidationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hos_id=sm.getID();
        Toast.makeText(getActivity(), hos_id, Toast.LENGTH_SHORT).show();
    ...
    private void hospital_reg() {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(config.auto_id,hos_id);
                params.put(config.Hospital_name,hos_name);
                params.put(config.auto_email,hos_email);
