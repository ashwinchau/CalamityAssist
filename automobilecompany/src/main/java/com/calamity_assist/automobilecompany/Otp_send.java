...
public class Otp_send extends AppCompatActivity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hos_email=getIntent().getExtras().getString("auto_email");
    ...
    public void onValidationSucceeded() {
        if(String.valueOf(r_no).equalsIgnoreCase(otp_check.getText().toString())){
            ...
            Intent in=new Intent(this,Reset_password.class);
            in.putExtra("auto_id",hos_id);
            startActivity(in);
        }
        else
        {
