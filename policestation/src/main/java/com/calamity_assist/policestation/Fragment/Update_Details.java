...
import com.calamity_assist.policestation.config;
...
public class Update_Details extends Fragment implements Validator.ValidationListener {
    ...
    View view=inflater.inflate(R.layout.fragment_update__details, container, false);
        ...
        edt_phone.setText(sm.getMobile());
    ...
    private void hospital_reg() {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(config.Police_id,hos_id);
                params.put(config.Police_name,hos_name);
                params.put(config.Police_email,hos_email);
                params.put(config.Police_address,hos_address);
                params.put(config.Police_phone,hos_phone);
                params.put(config.Police_website,hos_website);
                return params;
            }
